...
test.describe("Demo mode", () => {
  ...
  test('Cameras page shows empty state and "Pair camera" CTA', async ({
    ...
    const pairBtn = page.getByRole("button", {
      name: /pair (your first )?camera/i,
    });
  ...
  test("Rules page seeds three default rules", async ({ page }) => {
    ...
    await expect(page.getByText("Person in restricted zone")).toBeVisible();
